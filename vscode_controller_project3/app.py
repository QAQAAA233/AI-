"""Flask entry-point that wires the web UI with backend automation modules."""
...
from automation import ProgramManager, ScreenCapture
from core import (
    AIConfig,
    CONFIG_DIR,
    LOG_DIR,
...
window = None  # Webview window instance shared across routes
...
def capture_screenshots():
    ...
    try:
        ...
        elif capture_mode in {'programs', 'all'}:
            if window_titles or project_name:
                time.sleep(2)
                program_screenshots = ScreenCapture.capture_running_programs(window_titles, project_name)
